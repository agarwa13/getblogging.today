...
@section('description','Download the Free guide to show you how to create a blog that is beautiful and functional, all in an easy step-by-step tutorial (with annotated pictures).')
...
@section('content')
    ...
    <div class="jumbotron" id="welcome-jumbotron">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">
                        <a id="welcome-button" href="{{ url('/guide/download') }}" class="btn btn-lg btn-yellow m-t-lg">
                            Download the Guide
                        </a>
                    </div>
                </div>
    ...
    <div class="container m-b-m" id="easiest-guide-wrapper">
        ...
        <div class="row m-b-m">
            <div class="col-md-12">
                <div class="text-center">
                    <a id="welcome-button" href="{{ url('/guide/download') }}" class="btn btn-lg btn-yellow m-t-lg">Download the Guide</a>
                </div>
            </div>
        </div>
